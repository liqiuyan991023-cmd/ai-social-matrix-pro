                ...
                <div className="flex-1">
                  ...
                  <div className="mb-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4">
                      <div className="p-5 border border-gray-100 rounded-xl hover:shadow-md transition-shadow cursor-pointer bg-gray-50/50">
                        <Ico className="text-red-500 text-3xl mb-3" icon="mdi:youtube" />
                      ...
                      <div className="p-5 border border-gray-100 rounded-xl hover:shadow-md transition-shadow cursor-pointer bg-gray-50/50">
                        <Ico className="text-blue-500 text-3xl mb-3" icon="mdi:google" />
                        <h4 className="font-bold text-gray-900 mb-1 text-sm">
                          SEO 博客生成器
                        </h4>
                        <p className="text-xs text-gray-500">
                  ...
                  <div className="bg-indigo-600 rounded-3xl p-10 text-white flex flex-wrap gap-8 items-center justify-between">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-indigo-100 text-sm">平均点击率提升</div>
                    </div>
                    <div className="text-center">
                      <div className="text-4xl font-extrabold mb-1">1M+</div>
                      <div className="text-indigo-100 text-sm">全球活跃创作者</div>
                    </div>
              ...
              <div className="space-y-4">
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <p className="mt-4 text-gray-500 text-sm">
                    ...
                    (Shorts), Facebook, Twitter, LinkedIn 及 Pinterest。后续将增加更多小众高流量平台。
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                  <h4 className="font-bold flex justify-between items-center cursor-pointer">
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      "iconify-icon": React.ClassAttributes<HTMLElement> &
        React.HTMLAttributes<HTMLElement> & { icon?: string | undefined };
    }
  }
}
